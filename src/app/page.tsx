      ...
      <section className="relative flex min-h-[calc(100vh-4rem)] items-center overflow-hidden border-b bg-gradient-to-br from-[#FDF4EC] via-gray-50 to-[#FCE8D8] px-4 py-16 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 sm:py-24 md:py-32">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 opacity-40">
          <WavyBackground
            ...
            colors={["#E97D3A", "#D97030", "#C96328", "#6B7280", "#374151"]}
            backgroundFill="transparent"
          />
        </div>

        <div className="pointer-events-none absolute inset-0 z-[1] bg-grid-slate-100 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.5))] dark:bg-grid-slate-700/25" />
        <div className="relative z-10 mx-auto flex w-full max-w-7xl items-center">
          <div className="mx-auto w-full max-w-3xl text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl font-semibold text-base text-muted-foreground sm:mb-10 sm:text-lg md:text-xl">
